...
% Shuqi Chi, Shanshan Li, Yong Guo, Wei Dong, \textbf{Zhouyang Jia}, Haochen He, and Qing Liao. NotOnlyLog: Mining Patch-Log Associations from Software Evolution History to Enhance Failure Diagnosis Capability [C]. In: Proceedings of the 25th Asia-Pacific Software Engineering Conference. APSEC 2018. 189-198.

% \subsection*{2017}

% Wang Li, Shanshan Li, Xiangke Liao, Xiangyang Xu, Shulin Zhou, and \textbf{Zhouyang Jia}. ConfTest: Generating Comprehensive Misconfiguration for System Reaction Ability Evaluation [C]. In: Proceedings of the 21st International Conference on Evaluation and Assessment in Software Engineering. EASE 2017. 88–97.
\end{rSection}
